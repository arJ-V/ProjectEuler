'''
find the greatest product of 4 adjacent ("touching" or diagonal) in this 20x20 grid
some cool methods to reduce by bitrake via asm however, python solution is O(n^2)
'''
def max_prod(grid):
    max_product = 0
